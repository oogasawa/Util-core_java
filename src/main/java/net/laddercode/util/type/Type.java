...
import net.laddercode.util.string.DoubleToString;
...
*/
    ...
    /**  Returns an {@code Double} instance representing the specified boolean value.
     *
     * @param b - an {@code boolean} value.
     * @returns an {@code Double} instance representing b (true is 1.0, false is 0.0).
     */
    ...
    /**  Returns an {@code Double} instance representing the specified String object.
     *
    ...
    /**  Returns an {@code String} instance representing the specified boolean value.
     *
     * @param b - an {@code boolean} value.
     * @returns an {@code String} instance representing b ("true" or "false").
     */
